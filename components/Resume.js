                    ...
                    <div className="resume-item wow fadeInUp delay-0-3s">
                      ...
                      <div className="content">
                        <span className="years">
                          {new Date(time.startDate).getFullYear()} - {new Date(time.endDate) > Date.now()? "Present" : new Date(time.endDate).getFullYear()}
                        </span>
                        <h4>{time.jobTitle}</h4>
                        <span className="company">{time.company_name}</span>
                      </div>
                    </div>
                  </div>
                ))}
